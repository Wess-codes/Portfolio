...
<motion.h4 
      ...
      <motion.p 
        ...
        Welcome to my portfolio! You can explore a selection of my work .Take a look at my projects and see how I can help bring your ideas to life.
      </motion.p>
      <motion.div 
       initial={{opacity:0 }}
       whileInView={{opacity:1 }}
  ...
  href="#"
  className="w-max flex items-center justify-center gap-2 text-gray-700 border border-gray-500 rounded-full py-3 px-10 mx-auto my-20 hover:bg-gray-100 duration-500 transition-colors dark:hover:bg-darkHover dark:text-white dark:border-white "
>
  Show more
